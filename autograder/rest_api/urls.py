...
urlpatterns = [
    ...
    path('courses/<int:pk>/users/<username_or_pk>/late_days/', views.LateDaysView.as_view(),
         name='user-late-days'),
    path('courses/<int:pk>/late_days/', views.ListLateDaysForUserView.as_view(),
         name='list-user-late-days'),
